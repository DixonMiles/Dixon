...
#####################################################
# * Author    : Dixon Miles                    #
# * Facebook  : https://facebook.com/dixon      #
# * GitHub    : https://github.com/DixonMiles          #
...
def logo():
	os.system("clear")
	print("  \033[0;92m___ ___ __  __ ___ ___ \n \033[0;91m/ __|_ _|  \/  | _ ) __| \033[0;91mAU\033[0;97m : Dixon Miles\n\033[0;97m \__ \| || |\/| | _ \ _|  \033[0;91mFB\033[0;97m : FB.ME/Dixon Miles\n\033[0;96m |___/___|_|  |_|___/_|   \033[0;92mGH\033[0;91m : GITHUB.COM/DixonMiles")
...
def menu():
	...
	print(" \033[0;97m[\033[0;93m#\033[0;97m] --------------Dixon------------------------------") 
	...
	if ask =="":
		...
		if ask =="":
			...
			try:
				...
				print("\n \033[0;97m[\033[0;93m#\033[0;97m] ----------------------Dixon----------------------")
				...
				exit(" \033[0;97m[\033[0;93m#\033[0;97m] --------------Dixon------------------------------")
			except (IOError):
...
def settua():
	...
	if ask =="":
		...
		try:
			ua = s.get("https://raw.githubusercontent.com/DixonMiles/data-DixonMiles/main/ua.txt").text.strip()
			save = open(".ua","w")
			save.write(ua) 
			save.close()
